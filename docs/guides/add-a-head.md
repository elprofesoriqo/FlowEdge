...
A head consumes a conditioning vector and returns an action. It is one module under `src/heads/`. Follow the flow head.
...
Reference: `src/heads/flow/flow.h` and `flow.cc`.
