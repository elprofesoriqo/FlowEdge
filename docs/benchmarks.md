...
**CPU available · CUDA flow head device-resident · Tenstorrent planned**. Do not publish a CUDA vs PyTorch policy p50 ([#163](https://github.com/elprofesoriqo/FlowEdge/issues/163)).
