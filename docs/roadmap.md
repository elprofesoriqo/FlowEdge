...
| Layer | Complete |
|---|---|
| Core | Mamba, flow head, CPU kernels, BF16 weights, C/C++/Python APIs, SmolVLA suffix projection boundary |
...
| 3 | Exact SmolVLA reference contract | Pinned real-checkpoint preflight and suffix projection parity; source-encoder parity and complete action-expert execution still required |
...
Tenstorrent execution remain unimplemented; the suffix projection is an explicit first
