...
| Keep | Leave |
|---|---|
| Hardware: CPU now; Jetson/ARM via plugin; CUDA flow and DP heads; matched GPU replay on GTX 1650 ([#163](https://github.com/elprofesoriqo/FlowEdge/issues/163)) | Robot e-stop and joint limits |
