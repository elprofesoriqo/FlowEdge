...
Current product: CPU Core (Mamba + flow, Diffusion Policy, Transformer decoder fixture, cached SmolVLA expert), LeRobot plugin, optional Relay. CUDA is the next backend — attach work to [#160](https://github.com/elprofesoriqo/FlowEdge/issues/160) rather than dumping a U-Net. Tenstorrent (Metal), π0, and ACT stay behind that evidence.
